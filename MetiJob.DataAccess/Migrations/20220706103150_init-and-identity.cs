...
{
    public partial class initandidentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HaveJob = table.Column<bool>(type: "bit", nullable: true),
                    ProfessionalSkills = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IranStates = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JobCategories = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SeniorityLevels = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IsSeeable = table.Column<bool>(type: "bit", nullable: true),
                    ResumeAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelLanguage = table.Column<int>(type: "int", nullable: true),
                    IsRemoved = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
